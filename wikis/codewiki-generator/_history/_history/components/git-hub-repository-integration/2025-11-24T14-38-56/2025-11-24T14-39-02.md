...
- **processRepository suite**: [Repository-scale batch processing with state management](../_history/concepts/repository-scale-batch-processing-with-state-management/2025-11-24T14-38-57.md), cost tracking, and meta-analysis integration