...
related: [concepts/comprehensive-wiki-dashboard-system.md, concepts/multi-service-dashboard-architecture.md]
created: 2025-11-24
updated: 2025-11-24
---
...
The project lifecycle management component provides comprehensive CRUD operations for wiki projects, handling complete project workflows including creation, import, deletion, and configuration management. It serves as the central orchestrator for project operations within the [comprehensive wiki dashboard system](../concepts/comprehensive-wiki-dashboard-system.md), managing project metadata, validation, and settings persistence throughout the entire project lifecycle.
