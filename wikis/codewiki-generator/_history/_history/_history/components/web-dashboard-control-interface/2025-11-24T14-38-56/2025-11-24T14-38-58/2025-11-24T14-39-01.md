...
The controller renders an interactive dashboard view displaying current processing state and exposes a JSON endpoint (`getStatus`) for [real-time status polling](../_history/_history/_history/components/real-time-status-polling/2025-11-24T14-38-56/2025-11-24T14-38-58/2025-11-24T14-39-01.md). This allows the UI to stay synchronized with backend processing progress without forcing page refreshes.
