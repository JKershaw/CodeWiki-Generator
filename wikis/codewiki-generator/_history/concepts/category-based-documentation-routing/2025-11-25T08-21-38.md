...
- **Code Analysis Agent**: Provides concept categorization during code analysis
- **Documentation Writer Agent**: Uses category information for appropriate content generation
