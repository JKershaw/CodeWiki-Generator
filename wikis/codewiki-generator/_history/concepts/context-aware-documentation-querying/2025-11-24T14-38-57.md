...
related: [_history/_history/concepts/context-aware-documentation-querying/2025-11-24T14-38-57/2025-11-24T14-38-58.md]
created: 2025-11-24
updated: 2025-11-24
---

# [Context-aware Documentation Querying](../_history/_history/concepts/context-aware-documentation-querying/2025-11-24T14-38-57/2025-11-24T14-38-58.md)

## Purpose and Overview

The [Context-aware Documentation Querying](../_history/_history/concepts/context-aware-documentation-querying/2025-11-24T14-38-57/2025-11-24T14-38-58.md) system provides an MCP (Model Context Protocol) server that enables AI tools like Claude Code to intelligently search and retrieve documentation from the project wiki. It implements JSON-RPC 2.0 over stdio to facilitate seamless integration with AI development workflows, allowing tools to gather contextual documentation based on specific tasks and queries.
...
- **Intelligent Wiki Search**: Uses WikiResearcher to perform context-aware searches with [task-type optimization](../_history/concepts/task-type-optimization/2025-11-24T14-38-57.md) and relevance scoring
