...
- Clear specification of behavior before code exists
...
**State Persistence**: [[File-Based State Persistence With Directory Handling]], [[Persistent State Management With Validation]], [[State Schema Validation Pattern]]

**GitHub Integration**: [[GitHub API Client With Resilient Retry Logic]], [[Structured Git Metadata Extraction]], [[Repository URL Parsing And Normalization]]

**Configuration**: [[Singleton Configuration Module]], [[Environment-Based Configuration With Test Mode Separation]], [[Configuration Validation Pattern]]

**Testing Infrastructure**: [[Mock Credential Injection For Testing]], [[Test Environment Setup And Initialization]], [[Test Isolation Through Environment Configuration]]

See also: [[Source Code Organization Pattern]], [[Lazy-Loaded External Dependencies]]
