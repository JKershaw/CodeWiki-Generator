...
- **Global metadata tracking system**: Provides the underlying data structure and persistence layer
- **Category-based page classification**: Relies on the lifecycle management to maintain category statistics and page classifications
