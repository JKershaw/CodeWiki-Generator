...
- **Cost-aware API usage tracking** - ensures retry attempts are properly tracked for accurate cost calculations
- **Test-mode aware SDK initialization** - respects test mode configuration to avoid actual API calls during testing
