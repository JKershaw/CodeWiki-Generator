...
related: [components/test-coverage-analysis.md, meta/overview.md, components/test-statistics-extraction.md]
created: 2025-11-25
updated: 2025-11-25
---
...
This component is part of the larger **[Test Coverage Analysis](../components/test-coverage-analysis.md)** system in `lib/test-coverage-analyzer.js`. It works closely with:

- **[Test Statistics Extraction](../components/test-statistics-extraction.md)**: Provides discovered test files for metric parsing and analysis
- **[Test Coverage Analysis](../components/test-coverage-analysis.md)**: Serves as the foundation for determining which source files have corresponding tests
