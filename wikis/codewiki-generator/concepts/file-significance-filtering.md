...
related: [components/processor-class.md, meta/overview.md, components/code-analysis-agent.md]
created: 2025-11-25
updated: 2025-11-25
---
...
- **[Processor class](../components/processor-class.md)** - Contains the filtering logic as part of the commit processing workflow
- **[Code Analysis Agent](../components/code-analysis-agent.md)** - Receives only pre-filtered significant files for analysis
